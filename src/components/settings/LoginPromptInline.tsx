  ...
  return (
    <div className="bg-surface rounded-2xl p-6 shadow-sm flex flex-col items-center text-center gap-3 scroll-mt-24">
      ...
      <button
        ...
        className="inline-flex items-center gap-2.5 h-11 px-5 rounded-full border border-border bg-surface hover:bg-primary-soft text-text-primary text-sm font-semibold shadow-sm transition-all active:scale-95"
      >
