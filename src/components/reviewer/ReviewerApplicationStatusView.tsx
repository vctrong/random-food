    ...
    <div className="max-w-3xl mx-auto flex flex-col gap-5">
      <div className="bg-surface rounded-2xl border border-border shadow-sm p-5 sm:p-6 flex flex-col gap-4">
        {access.state === "pending" ? (
          ...
          <>
            <span className="inline-flex items-center gap-1.5 w-fit px-2.5 py-1 rounded-full bg-primary-pink/15 text-primary-pink text-xs font-semibold">
            ...
            <div className="p-3 rounded-xl bg-primary-pink/10 flex flex-col gap-1.5">
      ...
      <div className="bg-surface rounded-2xl border border-border shadow-sm p-5 sm:p-6 flex flex-col gap-4">
        ...
        <SummaryRow label="Khẩu vị sở trường">
          <div className="flex flex-wrap gap-1.5">
            {application.expertise.map((category) => (
              <span key={category.id} className="px-2.5 py-1 rounded-full bg-soft-pink text-primary-pink text-xs font-medium">
                {category.name}
              </span>
            ))}
          </div>
        ...
        <SummaryRow label="Bài trả lời tình huống">
          <p className="whitespace-pre-line p-3 rounded-xl bg-cream">{application.scenarioAnswer || "—"}</p>
        </SummaryRow>
      </div>
