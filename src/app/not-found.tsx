  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24">
      <div className="flex flex-col items-center text-center">
        <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-surface text-primary text-sm font-semibold shadow-sm mb-6">
          <UtensilsCrossed className="size-4" aria-hidden />
          <span>Lỗi bàn ăn · 404</span>
        </div>

        <span className="font-heading font-extrabold leading-none tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary to-accent text-[96px] sm:text-[128px] select-none">
          404
        </span>

        <div className="w-40 h-40 sm:w-48 sm:h-48 rounded-full bg-surface shadow-inner flex items-center justify-center text-primary -mt-4 mb-6">
