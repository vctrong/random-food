  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24">
      <div className="flex flex-col items-center text-center">
        <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-surface text-accent-ink text-sm font-semibold shadow-sm mb-6">
          <ServerCrash className="size-4" aria-hidden />
          <span>Đã có lỗi xảy ra · 500</span>
        </div>

        <span className="font-heading font-extrabold leading-none tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-accent via-accent to-primary text-[96px] sm:text-[128px] select-none mb-6">
          500
        </span>
